...
const arrayLessThan5 = (nums) => {
  return nums.filter((num) => {return num < 5})
  //
};

const arrayOddLengthWords = (words) => {
  return words.filter((word) => {return word.length  % 2 !== 0})
};

// Find

const firstValDivisibleBy4 = (nums) => {
  return nums.find((num) => {return num % 4 == 0})
};

const firstWordLongerThan4Char = (words) => {
  return words.find((word) => {return word.length > 4})
};
